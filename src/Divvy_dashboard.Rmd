...
chi_zips <- geojsonio::geojson_read('/Users/zacklarsen/Zack_Master/Projects/Dataviz/R/Divvy_Flex/data/Chicago_Zipcodes.geojson',
                                      what = "sp")
...
print(paste("TimeStamp:",stations$executionTime))

print(paste("Total Docks:",sum(stations$stationBeanList$totalDocks)))

print(paste("Total Docks Available:",sum(stations$stationBeanList$availableDocks)))
